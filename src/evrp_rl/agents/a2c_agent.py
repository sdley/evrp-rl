...
class A2CAgent(BaseAgent):
    ...
    def update(
        ...
        # - Minimize actor_loss (policy improvement)
        # - Minimize critic_loss (better value estimates)
        # - Maximize entropy (exploration) = subtract entropy from loss
        # Note: We report total_loss for logging, but negative values are OK when entropy is high
